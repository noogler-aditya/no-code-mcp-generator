            ...
            <div className="relative z-10 w-full max-w-4xl mx-auto text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.03] border border-white/[0.08] backdrop-blur-md mb-8 hover:bg-white/[0.05] transition-colors cursor-default">
                        ...
                        <span className="text-sm font-medium text-blue-100/80">Support for Swagger 2.0 & OpenAPI 3.0</span>
                    </div>
                    ...
                    <p className="text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto mb-16 leading-relaxed font-light text-balance">
                        Instantly transform your existing OpenAPI documentation into a production-ready <strong className="text-zinc-200 font-medium">Model Context Protocol (MCP)</strong> server. No code required.
                    </p>
                </motion.div>
                ...
                >
                    <p className="text-sm text-white/30 uppercase tracking-widest mb-6">Trusted by developers at</p>
